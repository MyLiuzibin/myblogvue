...
<!--									<el-menu-item index="/LikeCollect?like=2">收藏的文章</el-menu-item>-->
	...
	<div class="headImgBox" :style="{backgroundImage:headBg?headBg:'url(static/img/headbg04.png)'}">
		<div class="scene">
			<div><span id="luke"></span></div>
		</div>
		<div class="h-information">
			<a href="#/Aboutme">
                    <img :src="headTou?headTou:'static/img/tou.jpg'" alt="">
                </a>
...
export default {
	data() { //选项 / 数据
		return {
			...
			// path:'',//当前打开页面的路径
			input: '', //input输入内容
			headBg: 'url(static/img/headbg04.png)', //头部背景图
			headTou: 'static/img/tou.jpg', //头像
			projectList: '', //项目列表
      user_start:'Hi,ZiBin'
		}
	},
	...
	mounted() { //页面元素加载完成
		...
		var timer = setTimeout(function() {
		  console.log(that.user_start)
			Typeit('zibin', "#luke"); //打字机效果
			clearTimeout(timer);
		}, 500);
	}
}
