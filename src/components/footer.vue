...
<template>
    ...
    <div v-if="this.$store.state.themeObj.user_start!=0" class="footBack footBackQian">
        ...
        <div class="fcontainer">
            ...
            <p>
                托管于 <a href="https://github.com/MyLiuzibin" target="_blank">GitHub</a>. <a href="https://www.aliyun.com/?spm=a2c49.11131515.0.0.5Z9AkR" target="_blank">阿里云</a> 提供静态文件云存储服务. <a href="https://tongji.baidu.com/web/welcome/login" target="_blank">百度统计</a> 提供网站统计服务. <a href="https://www.cloudxns.net/Order/index.html" target="_blank">CloudXNS</a> 提供 DNS 解析服务.
            </p>
            <p>
            ...
            <p>
                <span>Made with</span> <img class="fheart" src="static/img/heart02.png"/>  <span>by ZiBin.</span>
            </p>
        </div>
    </div>
    <!-- Qinlh的 -->
    ...
    export default {
        ...
        methods: { //事件处理器
            runTime:function(){//运行倒计时
                var that = this;
                var oldTime =new Date('2020/08/09 00:00:00');
