  ...
  <div class="detailBox tcommonBox">
    ...
    <header>
      ...
      <h2>
        ...
        <i class="fa fa-fw fa-eye"></i>{{detailObj.articleViews}} 次围观 •
        <i class="fa fa-fw fa-comments"></i>活捉 {{detailObj.commentsNu}} 条 •
        <span class="rateBox">
    ...
    methods: { //事件处理器
      ...
      routeChange: function () {
        ...
        getArticleInfo(that.aid, that.userId, function (msg) {
          ...
          that.detailObj = msg;
          that.likeCount = msg.loveNu ? msg.loveNu : 0;
          that.collectCount = msg.collectNu ? msg.collectNu : 0;
          that.likeArt=false;
