...
<template>
    <div class="rightlistBox">
        <section :class="fixDo?'rs1 fixed':'rs1'" @click="lovemeFun">
            <div class="r1-head">
                <img :src="this.centerSmailimg?this.centerSmailimg:'static/img/headtou02.jpg'" alt="">
        ...
        <section class="rs4">
            ...
            <ul>
                <li v-for="(item,index) in browseList" :key="'browseList'+index">
                    <a :href="'#/DetailShare?aid='+item.articleId" target="_blank">{{item.articleTitle}}</a> —— {{item.articleViews}} 次围观
                </li>
            </ul>
        </section>
        <!-- 右侧上滑小图片 -->
    ...
    export default {
        data() { //选项 / 数据
            return {
                ...
                centerSmailimg:'static/img/tou3.jpg',//侧边头像
                catchMeObj:{//抓住我 个人信息
                    Aimee:{
                        git: 'https://github.com/MyLiuzibin',
